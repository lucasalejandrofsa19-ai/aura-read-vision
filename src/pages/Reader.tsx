              ...
              bookmarkIndicator={
                bookmarkedPage === currentPage && (
                  <motion.div
                    initial={{ opacity: 0, y: -20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-accent text-accent-foreground px-6 py-3 md:px-4 md:py-2 rounded-full shadow-lg flex items-center gap-2 md:gap-2 mb-4"
                  >
                    <BookmarkCheck className="w-6 h-6 md:w-4 md:h-4" />
                    <span className="text-base md:text-sm font-semibold md:font-medium">Página marcada</span>
                  </motion.div>
                )
              }
            />
