...
export const MagicLinkEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Seu acesso instantâneo ao {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={lead}>
          Sem senhas, sem fricção. Use o link abaixo para acessar sua biblioteca
          inteligente — válido pelos próximos minutos.
        </Text>
